...
public class Q4_1_Counterexample {
	...
	public static void main(String[] args) throws IOException {
		...
		ArrayList<Integer> desired = new ArrayList<Integer>(Arrays.asList(3, 2, 0, 4, 5, 1, 6, 7, 8, 9, 10));
		for (long i = 1; i <= 39916800; i++) { // Means 11! permutations are processed in this case
